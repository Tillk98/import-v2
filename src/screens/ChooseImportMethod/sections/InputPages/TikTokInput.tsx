      ...
      <div className="w-full bg-white rounded-lg shadow-md p-8">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl font-semibold text-black">Import from TikTok</h1>
            <p className="text-[#6b7280] text-base">
              Use our browser extension to turn TikTok content – videos and posts – into lessons.
            </p>
          </div>
        </div>
      </div>
              ...
              {currentStep > 1 ? (
                ...
                <>
                  <p className="text-gray-600 mb-4">
                    Add our browser extension to import content directly from TikTok with one click.
                  </p>
                  <button
          ...
          <div className="flex items-start gap-6">
            ...
            <div className="flex-1">
              <div className="mb-2">
                ...
                <h3 className={`text-xl font-semibold ${currentStep >= 2 ? 'text-black' : 'text-gray-400'}`}>Start learning on TikTok</h3>
              </div>
              <p className={`mb-4 ${currentStep >= 2 ? 'text-gray-600' : 'text-gray-400'}`}>
                Browse TikTok, find content in your target language, and click the LingQ extension to create interactive lessons instantly.
              </p>
