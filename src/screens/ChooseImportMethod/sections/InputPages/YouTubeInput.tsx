            ...
            {currentStep > 1 ? (
              ...
              <>
                <p className="text-gray-600 mb-4">
                  Add our browser extension to import content directly from YouTube with one click.
                </p>
                <button
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="flex-1">
            <div className="mb-2">
              ...
              <h3 className={`text-xl font-semibold ${currentStep >= 2 ? 'text-black' : 'text-gray-400'}`}>Start learning on YouTube</h3>
            </div>
            <p className={`mb-4 ${currentStep >= 2 ? 'text-gray-600' : 'text-gray-400'}`}>
              Browse YouTube, find content in your target language, and click the LingQ extension to create interactive lessons instantly.
            </p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-yellow-700 text-sm mb-2">
                        New to importing YouTube content? Watch our step-by-step video guide to see exactly how it works.
                      </p>
